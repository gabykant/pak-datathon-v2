...
export type AnalyticsComplexity = 'Faible' | 'Moyenne' | 'Élevée'
...
export type ChatProblemInsight = {
  ...
  impactScore: number
  dataVolumeEstimateGb: number
  analyticsComplexity: AnalyticsComplexity
...
export type ChatTimelinePoint = {
  ...
  resolvedAfterEscalation: number
}

export type ChatKeywordFrequency = {
  theme: string
  mentions: number
  cluster: keyof typeof clusterLabels
}
...
export const chatTimeline: ChatTimelinePoint[] = [
  { month: 'Août 2024', incidents: 18, criticalBlockers: 6, resolvedAfterEscalation: 5 },
  { month: 'Sept 2024', incidents: 33, criticalBlockers: 13, resolvedAfterEscalation: 10 },
  { month: 'Oct 2024', incidents: 41, criticalBlockers: 17, resolvedAfterEscalation: 13 },
  { month: 'Nov 2024', incidents: 36, criticalBlockers: 14, resolvedAfterEscalation: 12 },
]

export const chatKeywordFrequencies: ChatKeywordFrequency[] = [
  { theme: 'Accès / validation code', mentions: 128, cluster: 'COORDINATION' },
  { theme: 'BAS / incohérence dossier', mentions: 117, cluster: 'DOCUMENTAIRE' },
  { theme: 'Scan / inspection', mentions: 93, cluster: 'OPERATIONNEL' },
  { theme: 'Plateforme / réseau indisponible', mentions: 141, cluster: 'SYSTEMES_IT' },
  { theme: 'Retour des vides', mentions: 74, cluster: 'LOGISTIQUE_TRANSPORT' },
  { theme: 'Validation intermédiaire/finale', mentions: 68, cluster: 'COORDINATION' },
  { theme: 'Horaires / saturation fenêtres', mentions: 52, cluster: 'OPERATIONNEL' },
  { theme: 'Manifeste / conformité', mentions: 39, cluster: 'REGLEMENTAIRE' },
]
...
export const chatProblemInsights: ChatProblemInsight[] = [
  {
    ...
    frequencyScore: 95,
    impactScore: 93,
    dataVolumeEstimateGb: 12,
    analyticsComplexity: 'Moyenne',
  ...
  },
  {
    ...
    evidencePattern: 'Défaut de scan, inspection en attente avec délais de plusieurs jours.',
    frequencySignal: 'Signal fort et transversal (scan/inspection mentionné de manière continue).',
    frequencyScore: 87,
    impactScore: 92,
    dataVolumeEstimateGb: 16,
    analyticsComplexity: 'Élevée',
    operationalNarrative:
  ...
  },
  {
    ...
    cluster: 'SYSTEMES_IT',
    title: 'Instabilité plateformes et indisponibilités réseau',
